...
export type { IAddressTagPair, IAddressTag, IAddressTagSource, IAddressTagGroup, IAddressTagRename, IAddressTagListQuery, IAddressTagSearchQuery, IAddressTagAssertion, IAddressTagSyncResult, IAddressTagService } from './address-tags/index.js';
