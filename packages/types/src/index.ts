...
export type { IAddressTagPair, IAddressTag, IAddressTagRename, IAddressTagListQuery, IAddressTagSearchQuery, IAddressTagService } from './address-tags/index.js';
