...
export type { IAddressTagPair, IAddressTag, IAddressTagGroup, IAddressTagRename, IAddressTagListQuery, IAddressTagSearchQuery, IAddressTagService } from './address-tags/index.js';
