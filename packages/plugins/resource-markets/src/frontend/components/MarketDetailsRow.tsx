 ...
 *
 * The component provides the same content as the core markets feature but in an inline
 * format that integrates better with the table structure and provides a more direct
 * interaction pattern.
 *
 * @param context - Frontend plugin context for UI components, charts, and utilities
                        ...
                        <div className={styles.details_section}>
                            <div className="stack" style={{ gap: '1.5rem' }}>
                                ...
                                <div>
                                    ...
                                    {(market.isBestDeal || market.bulkDiscount?.hasDiscount) && (
                                        <div style={{ marginTop: '1rem', display: 'flex', gap: '0.5rem', flexWrap: 'wrap' }}>
                                            {market.isBestDeal && <ui.Badge tone="success">Best deal</ui.Badge>}
                                            {market.bulkDiscount?.hasDiscount && <ui.Badge tone="warning">Bulk discounts</ui.Badge>}
                                        </div>
                                    )}
                                </div>
                                ...
                                <section className={styles.stat_grid}>
                                    ...
                                    <ui.Card tone="muted" padding="sm" style={{ overflow: 'visible' }}>
                                        <div className="stat-card__label" style={{ display: 'flex', alignItems: 'center', gap: '0.25rem', overflow: 'visible' }}>
                                            Data Feed Reliability
                                            <ui.Tooltip content="Measures how often TronRelic successfully fetches pricing data from this marketplace's API. This reflects API uptime and data availability, not order fulfillment rates.">
