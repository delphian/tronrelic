/**
 * Barrel export for resource tracking shared types.
 *
 * Centralizes type definitions used by both backend observers/services
 * and frontend components to maintain a single source of truth.
 */
