...
export interface IContentSink {
    id: string;
    accepts: Array<'title' | 'body' | 'media' | 'fields'>;   // structural capability — the routing predicate
