...
- **A leading underscore marks anything java-tron does not define**, on tables and on columns alike: bookkeeping tables, and columns the ingest adds, such as `_provider`.
