...
| [system-account-value-ledger.md](./system-account-value-ledger.md) | Proposed source-independent value-transfer ledger for account history — domain model, `account_value_transfers` schema, staged migration plan |
