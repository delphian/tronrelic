...
interface IFrontendPluginContext {
    ...
    ui: IUIComponents;             // Card, Badge, Button, CopyButton, IconButton, Switch, Input, Select, Textarea, Skeleton, StatTile, StatGrid, ClientTime, Tooltip, IconPickerModal, ConfirmDialog, AccountPicker, AddressSelector, Table family
