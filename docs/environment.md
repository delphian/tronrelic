...
Before deploying to production, review the security checklist in [README.md - Security Checklist](../README.md#security-checklist) and the deployment documentation in the [tronrelic-ops repository](../../docs/operations/operations.md).
