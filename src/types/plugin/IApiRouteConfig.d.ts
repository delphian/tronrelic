 ...
 * ```
 */
export type ApiRouteHandler = (req: IHttpRequest, res: IHttpResponse, next: IHttpNext) => void | Promise<void>;
/**
 ...
 * ```
 */
export type ApiMiddleware = (req: IHttpRequest, res: IHttpResponse, next: IHttpNext) => void | Promise<void>;
/**
...
//# sourceMappingURL=IApiRouteConfig.d.ts.map