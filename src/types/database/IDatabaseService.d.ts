...
export interface IDatabaseService {
     ...
     * ```
     */
    createIndex(collectionName: string, indexSpec: Record<string, 1 | -1>, options?: {
        unique?: boolean;
        sparse?: boolean;
     ...
     * ```
     */
    count<T extends Document = Document>(collectionName: string, filter: Filter<T>): Promise<number>;
    /**
     ...
     * ```
     */
    find<T extends Document = Document>(collectionName: string, filter: Filter<T>, options?: {
        limit?: number;
        skip?: number;
     ...
     * ```
     */
    findOne<T extends Document = Document>(collectionName: string, filter: Filter<T>): Promise<T | null>;
    /**
     ...
     * ```
     */
    insertOne<T extends Document = Document>(collectionName: string, document: T): Promise<any>;
    /**
     ...
     * ```
     */
    updateMany<T extends Document = Document>(collectionName: string, filter: Filter<T>, update: UpdateFilter<T>): Promise<number>;
    /**
     ...
     * ```
     */
    deleteMany<T extends Document = Document>(collectionName: string, filter: Filter<T>): Promise<number>;
    /**
