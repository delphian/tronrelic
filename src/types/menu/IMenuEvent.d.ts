 ...
 */
export type MenuEventType = 'init' | 'ready' | 'loaded' | 'before:create' | 'after:create' | 'before:update' | 'after:update' | 'before:delete' | 'after:delete' | 'before:reorder' | 'after:reorder' | 'before:move' | 'after:move';
/**
...
//# sourceMappingURL=IMenuEvent.d.ts.map