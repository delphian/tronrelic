...
import type { IBaseObserver, IBaseBatchObserver, IBaseBlockObserver, IBlockData, IObserverStats, ISystemLogService, ITransaction, TransactionBatches } from '@/types';
