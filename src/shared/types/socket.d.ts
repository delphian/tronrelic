...
export type TronRelicSocketEvent = TransactionAlertPayload | BlockNotificationPayload | CommentsUpdatePayload | ChatUpdatePayload | MemoUpdatePayload | UserUpdatePayload;
