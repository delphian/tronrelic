 ...
 * webhook processing.
 */
export async function validateTelegramIp(req, allowedCidrs) {
    ...
    try {
        ...
        for (const cidr of cidrs) {
            ...
            const matches = addr.match(rangeAddr, prefixLength);
            if (matches) {
                return true;
            }
        }
 ...
 */
export async function validateTelegramWebhook(req, options = {}) {
