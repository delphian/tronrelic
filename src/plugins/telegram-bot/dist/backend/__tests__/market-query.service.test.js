 ...
 * Provides a complete ISystemLogService interface with spy functions.
 */
class MockLogger {
    level = 'info';
    fatal = vi.fn();
    ...
    async getStatistics() { return { total: 0, byLevel: {}, byService: {}, unresolved: 0 }; }
    async getLogById() { return null; }
    async markAsUnresolved() { return null; }
    async deleteAllLogs() { return 0; }
    async getStats() { return { total: 0, byLevel: {}, resolved: 0, unresolved: 0 }; }
}
/**
...
describe('MarketQueryService - Single Market Tests', () => {
    ...
    beforeEach(() => {
        ...
        service = new MarketQueryService('http://test-api', mockLogger);
    });
    /**
...
//# sourceMappingURL=market-query.service.test.js.map