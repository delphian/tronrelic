...
describe('Telegram Bot Plugin - /config endpoint', () => {
     ...
     */
    function createMockContext(siteUrl, dbConfig) {
    ...
    it('should dynamically calculate webhook URL from system config', async () => {
        ...
        await telegramBotBackendPlugin.init(mockContext);
...
//# sourceMappingURL=config-endpoint.test.js.map