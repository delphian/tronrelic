...
describe('TelegramBotService', () => {
    ...
    describe('Message Sending', () => {
        ...
        it('should return false for isSubscribed when not implemented', async () => {
            ...
            expect(mockLogger.info).toHaveBeenCalledWith({ telegramUserId: 123456, subscriptionType: 'whale-alerts' }, 'TelegramBotService.isSubscribed called (not yet implemented)');
        });
    });
});
//# sourceMappingURL=telegram-bot.service.test.js.map