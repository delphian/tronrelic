...
export type { ITelegramChannel } from './types/ITelegramChannel.js';
...
export type { IPluginTelegramBotConfig, IPluginTelegramBotConfigMasked } from './types/IPluginTelegramBotConfig.js';
