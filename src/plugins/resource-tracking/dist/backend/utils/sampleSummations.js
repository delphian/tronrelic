 ...
 * ```
 */
export function sampleSummations(records, requestedPoints, startDate, endDate) {
    ...
    return {
        data: sampledData, // TypeScript doesn't know we're mixing null and ISummationData
        metadata: {
            requestedPoints,
 ...
 */
function aggregateBucket(bucket, fixedTimestamp) {
    if (bucket.length === 0) {
