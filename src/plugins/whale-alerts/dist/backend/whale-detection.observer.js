 ...
 */
export function createWhaleDetectionObserver(BaseObserver, observerRegistry, websocket, database, logger) {
    ...
    class WhaleDetectionObserver extends BaseObserver {
        ...
        async process(transaction) {
            ...
            scopedLogger.debug({ txId: transaction.payload.txId, amountTRX: amount }, 'Emitting whale transaction to large-transfer room');
            ...
            scopedLogger.debug({ txId: transaction.payload.txId, amountTRX: amount }, 'Emitted to large-transfer room');
        }
        /**
         ...
         */
        async persistWhaleTransaction(transaction, thresholdTRX, config) {
            ...
            scopedLogger.debug({ txId, amountTRX: whaleTransaction.amountTRX }, 'Persisted whale transaction');
        }
    }
