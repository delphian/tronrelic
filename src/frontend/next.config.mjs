...
const nextConfig = {
    ...
    webpack: (config, { isServer }) => {
        ...
        // Resolve .js extensions to .ts for TypeScript ESM imports
        // This is needed because TypeScript ESM uses .js extensions in imports
        // but webpack needs to resolve them to actual .ts files
                ...
                rule.oneOf.forEach(oneOfRule => {
                    ...
                    if (isScssModuleRule) {
                        ...
                        oneOfRule.include = (resourcePath) => {
                            ...
                            if (resourcePath.includes('/src/plugins/')) {
                                return true;
                            }
