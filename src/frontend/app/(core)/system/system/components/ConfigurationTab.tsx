 ...
 * providers that feed it — onto one tab,
 ...
 * Test button acts on the saved provider config alone. The site URL, the
 * sign-in button image, and the emit buffer share one database document but
 * send disjoint sets of fields, so no card's save can overwrite another's
 * values. New provider sections are added here beside TronScan.
 */
 ...
 *          buffer card, and the provider configuration cards.
 */
